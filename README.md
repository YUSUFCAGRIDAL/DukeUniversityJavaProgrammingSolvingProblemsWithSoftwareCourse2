...
Important Note: Some code should be run in a custom Bluej Development Environment made by Duke's University especially for this course. You can get the IDE from the University website <a href="http://www.dukelearntoprogram.com/downloads/bluej.php?course=2">here</a>.

<hr>

# YUSUF CAGRI DAL's note
 Here's <a href="https://www.coursera.org/account/accomplishments/verify/CQ33ZSYLHV8G">the link to my Certificate.</a>
